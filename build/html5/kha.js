...
MainKha.prototype = {
	...
	,render: function(framebuffer) {
		...
		var width = 1024;
		var height = 768;
		var this2 = new hxPixels__$Pixels_PixelsData(width,height,true);
		this1 = this2;
		...
		var image = _$Mandelbrot_Mandelbrot_$Impl_$.getKhaImage(mandelbrot);
		var g2 = framebuffer.get_g2();
		g2.begin();
		g2.clear(kha__$Color_Color_$Impl_$._new(-16777216));
...
_$Mandelbrot_Mandelbrot_$Impl_$._new = function(width_,height_,color) {
	var this1;
	var width = width_;
	var height = height_;
	var this2 = new hxPixels__$Pixels_PixelsData(width,height,true);
...
_$Mandelbrot_Mandelbrot_$Impl_$.getKhaImage = function(this1) {
	var image = kha_Image.fromBytes(this1.bytes,this1.width,this1.height,kha_graphics4_TextureFormat.RGBA32);
	return image;
};
_$Mandelbrot_Mandelbrot_$Impl_$.paint = function(this1,x,y,iter,color) {
	var red = iter > 255 ? 0 : iter * color;
...
hxPixels__$Pixels_Pixels_$Impl_$.fillRect = function(this1,x,y,width,height,value) {
	...
	while(_g1 < _g) {
		...
		var g = value >> 8 & 255;
		var b = value & 255;
		stridePixels.bytes.b[pos1 + stridePixels.format.ch0] = a & 255;
		stridePixels.bytes.b[pos1 + stridePixels.format.ch1] = r & 255;
		stridePixels.bytes.b[pos1 + stridePixels.format.ch2] = g & 255;
		stridePixels.bytes.b[pos1 + stridePixels.format.ch3] = b & 255;
	}
	var _g11 = 0;
	var _g2 = height;
	while(_g11 < _g2) {
...
hxPixels__$Pixels_Pixels_$Impl_$.fromImageData = function(image) {
	var this1 = new hxPixels__$Pixels_PixelsData(image.width,image.height,false);
	var pixels = this1;
	pixels.format = hxPixels_PixelFormat.RGBA;
	var u8ClampedArray = image.data;
	var u8Array = u8ClampedArray;
	pixels.set_bytes(haxe_io_Bytes.ofData(u8Array.buffer));
	return pixels;
};
hxPixels__$Pixels_Pixels_$Impl_$.applyToImageData = function(this1,imageData) {
...
hxPixels__$Pixels_Pixel_$Impl_$.get_fA = function(this1) {
	return (this1 >> 24 & 255) / 255.;
};
hxPixels__$Pixels_Pixel_$Impl_$.set_fA = function(this1,a) {
	this1 = this1 & 16777215 | (a * 255 | 0) << 24;
	return a;
};
hxPixels__$Pixels_Pixel_$Impl_$.get_fR = function(this1) {
	return (this1 >> 16 & 255) / 255.;
};
hxPixels__$Pixels_Pixel_$Impl_$.set_fR = function(this1,r) {
	this1 = this1 & -16711681 | (r * 255 | 0) << 16;
	return r;
};
hxPixels__$Pixels_Pixel_$Impl_$.get_fG = function(this1) {
	return (this1 >> 8 & 255) / 255.;
};
hxPixels__$Pixels_Pixel_$Impl_$.set_fG = function(this1,g) {
	this1 = this1 & -65281 | (g * 255 | 0) << 8;
	return g;
};
hxPixels__$Pixels_Pixel_$Impl_$.get_fB = function(this1) {
	return (this1 & 255) / 255.;
};
hxPixels__$Pixels_Pixel_$Impl_$.set_fB = function(this1,b) {
...
_$Mandelbrot_Mandelbrot_$Impl_$.MAX_ITER = 255;
